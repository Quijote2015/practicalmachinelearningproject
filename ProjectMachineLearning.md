...
```
The training data set is made of 19622 observations on 160 columns. We can notice that many columns have NA values or blank values on almost every observation. So we will remove them. In addition, the first seven columns give information about the people who did the test, and also timestamps. For this reason we will exclude them in our model.
...
![](ProjectMachineLearning_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](ProjectMachineLearning_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](ProjectMachineLearning_files/figure-html/unnamed-chunk-6-2.png)<!-- -->
...
![](ProjectMachineLearning_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
## 0.963907
```
Precision with 5 folds is 96.4%.
